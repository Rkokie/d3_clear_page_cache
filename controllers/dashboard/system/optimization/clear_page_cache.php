...
class DashboardSystemOptimizationClearPageCacheController extends Concrete5_Controller_Dashboard_Sitemap_Search {
	...
	public function view() {
		...
		if (is_object($pageList)) {
			...
			$packageTools = View::url('/tools/packages/d3_clear_page_cache');
			
			$this->addHeaderItem($html->javascript('javascript.js', 'd3_clear_page_cache'));
