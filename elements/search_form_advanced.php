...
<?php  $form = Loader::helper('form'); ?>
	...
	<form method="get" id="ccm-<?php echo $searchInstance?>-advanced-search" action="<?php echo View::url('/tools/packages/d3_clear_page_cache/search_results') ?>" class="form-horizontal">
