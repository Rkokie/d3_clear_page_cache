...
<div id="ccm-list-wrapper"><a name="ccm-<?php echo $searchInstance?>-list-wrapper-anchor"></a>
	<div style="margin-bottom: 10px">
		...
		<button class="button btn" id="btn-d3-clear-page-cache" data-instance-id="<?php echo $searchInstance?>"><?= t('Clear Cache from Selected Pages') ?></button>
	</div>
...
<?php 
	...
	$bu = REL_DIR_FILES_TOOLS_REQUIRED . '/../packages/d3_clear_page_cache/search_results';
